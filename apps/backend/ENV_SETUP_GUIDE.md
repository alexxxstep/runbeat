...
- `OPENAI_MODEL_PARSER` - для parser tools (парсинг даних)
- `OPENAI_MODEL_CONVERSATION` - для WorkoutBuilder (розмова та створення воркаутів)
- `OPENAI_MODEL_SUPERVISOR` - для SupervisorAgent (координація)
