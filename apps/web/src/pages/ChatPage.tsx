...
export function ChatPage() {
  ...
  return (
    <div className='flex flex-col h-screen bg-app-dark'>
      <Navbar />
      <div className='flex flex-1 md:flex-row overflow-hidden relative'>
        ...
        <div className='flex-1 md:flex-[3] flex flex-col bg-app-dark min-w-0'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                      ...
                      <div className='bg-app-surface rounded-xl p-4 border-2 border-app-accent'>
                        ...
                        <div className='text-subhead text-app-text-secondary mb-4'>
                          ...
                          <p>
                            {Math.round(variants.variant1.total_duration / 60)}{' '}
                            хв
                          </p>
                        </div>
                      ...
                      <div className='bg-app-surface rounded-xl p-4 border-2 border-app-accent'>
                        ...
                        <div className='text-subhead text-app-text-secondary mb-4'>
                          ...
                          <p>
                            {Math.round(variants.variant2.total_duration / 60)}{' '}
                            хв
                          </p>
                        </div>
          ...
          <InputBar
            onSend={handleSend}
            disabled={isLoading || loadingVariants}
          />
        </div>
